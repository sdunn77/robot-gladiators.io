...
for(var i = 0; i < enemyNames.length; i++) {
    if (playerHealth > 0) {
        // let the player know what round they are in, remember that arrays start at 0 it needs a 1 added to it
        ...
        window.alert("You have lost your robot in a battle! Game Over!");
        break;
    }
    }
